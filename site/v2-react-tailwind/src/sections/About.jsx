      ...
      <div className="about">
        <div className="about__header">
          ...
          <p className="about__intro">
            QA Team Lead with 7 years of experience focused on delivering high-quality software across web, mobile, and enterprise systems.
            Strong background in manual testing, test strategy, and QA leadership, with hands-on experience collaborating closely with
            development and product teams throughout the SDLC. Currently expanding into test automation and CI/CD through self-driven
